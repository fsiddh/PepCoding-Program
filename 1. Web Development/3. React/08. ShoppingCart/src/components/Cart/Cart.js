...
// ******** props required -> state.cart (id,qty) || useeffect->cart change=ui pr total qty,total price update || show items
...
function Cart1({ cart }) {
  ...
  // jab bhi cart change hti to ui pr jo change hta -> subtotal ("items") ,total price
    useEffect(() => {
      let items = 0;
      let price = 0;
